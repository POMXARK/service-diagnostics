	...
	<div class="pcoded-content">
		...
		<div class="row mb-3">
				<div class="col-md-8">
					...
					<p class="f-w-500">Check out <a href="http://html.phoenixcoded.net/nextro-new/docs/index-bc-package#page-badge" target="_blank" class="badge bg-light-primary">Documentation</a></p>
				</div>
		</div>
		<div class="row">
			<!-- [ badge ] start -->

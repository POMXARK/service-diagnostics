                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="inlineradiostate1"
                                               value="option1">
                                        <label class="form-check-label" for="inlineradiostate1">1</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="inlineradiostate2"
                                               value="option2">
                                        <label class="form-check-label" for="inlineradiostate2">2</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="inlineradiostate3"
                                               value="option3" checked>
                                        <label class="form-check-label" for="inlineradiostate3">3</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="inlineradiostate4"
                        ...
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="" id="flexCheckDisabled"
                                               disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="" id="customCheckinlh4"
                                               disabled>
                                        <label class="form-check-label" for="customCheckinlh4">
                                            4 (disabled)
                                        </label>
                                    </div>
                                    <small class="form-text d-block text-muted">Add <code>.form-check-inline</code> to
                                        any <code>.custom-control</code></small>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="" id="customCheckinlhstate3"
                                               checked>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="" id="customCheckinlhstate4"
                                               disabled>
                                        <label class="form-check-label" for="customCheckinlhstate4">
                                            4 (disabled)
                                        </label>
                                    </div>
                                    <small class="form-text d-block text-muted">Add <code>checked</code> attribute to
                                        any <code>.form-check-input</code></small>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input input-warning" type="radio"
